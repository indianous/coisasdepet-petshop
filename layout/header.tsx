...
export default function Header(props: Props) {
  return (
    <div className="container">
        <header className={`d-flex flex-column align-items-center flex-md-row justify-content-md-between ${props.className || ''}`}>
            <Nav className='nav mb-1'/>
            <form className="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search">
                <div className="input-group">
                    <input type="text" className="form-control" placeholder="Pesquisar..." aria-label="Input group example" aria-describedby="basic-addon1"/>
