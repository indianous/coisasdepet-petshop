  ...
  return (
    <div className="card">
      ...
      <div className="card-body">
        <p className="card-text">Entregar: Endereço</p>
      ...
      <div className="card-footer">Total: R$ 20,00</div>
    </div>
  );
}
...
export function Payment(): JSX.Element {
  ...
  const expiryChange = (event): void => {
    setExpiry(event.target.value);
  };

  const cardNumberChange = (event): void => {
    setCardNumber(event.target.value);
  };

  const cvvChange = (event): void => {
    setCvv(event.target.value);
  };

  const shippingChange = (event): void => {
  ...
  return (
    <div className="card">
      ...
      <div className="card-footer">
        <span className="card-text">Total: R$ 120,00</span>
      </div>
    </div>
  );
}
...
export function CartItem(props: CartItemProps): JSX.Element {
  ...
  return (
    <li className="list-group-item">
      ...
      <button className="btn badge position-absolute start-100 top-0 translate-middle rounded-pill bg-danger">
        X
      </button>
    </li>
  );
...
export default function Cart(): JSX.Element {
  const viewItems = [
    {
      imgUrl:
        "https://images.pexels.com/photos/13779112/pexels-photo-13779112.jpeg",
  ...
  const shippingItems = [
    { name: "Retirada no local", price: 0.0, time: "1 dia", id: "1" },
    { name: "Sedex", price: 18.9, time: "De 7 a 15 dias", id: "2" },
    { name: "Transportadora", price: 27.9, time: "De 1 a 3 dias", id: "3" },
  ];
  // const cart = {
  //   products: [
  //     {
